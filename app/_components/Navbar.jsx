...
import { BsChevronDown, BsX } from 'react-icons/bs'; // Importing the arrow and close icons
...
const Navbar = () => {
  ...
  return (
    <nav className='bg-navy relative z-10'>
          ...
          <div className='flex items-center'>
            <div className='flex-shrink-0'>
              <div className="flex items-center">
                ...
                <div className="ml-2">
                  <h2 className="hidden lg:block text-white text-xl font-bold">Shri Vishnu Engineering College For Women</h2>
                  <h2 className="sm:block lg:hidden text-white text-xl font-bold ">SVECW</h2>
                  <h3 className="hidden lg:block text-white text-md">Bhimavaram, Andhra Pradesh</h3>
                  <h3 className="sm:block lg:hidden text-white text-md">Bvrm, Andhra Pradesh</h3>
                </div>
              </div>
            </div>
          </div>
              ...
              {menuList.map((menuItem) => (
                <div key={menuItem.id}>
                  {menuItem.subItems ? (
                    ...
                    >
                      <button className='text-white font-serif hover:white text-xl hover:font-bold p-2 flex items-center' onClick={() => toggleMenu(menuItem.id)}>
                    ...
                    <Link href={menuItem.path} className='text-white text-xl hover:white hover:font-bold rounded-lg p-2 font-serif'>
                      {menuItem.name}
                    </Link>
                  )}
                </div>
