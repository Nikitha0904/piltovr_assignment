...
const AboutPage = () => {
    return (
        <div className="container mx-auto py-8">
            <h1 className="text-5xl text-center font-semibold mb-4 font-serif mt-16">About SVECW</h1>

            <div className="bg-white rounded-lg shadow-lg p-8 mb-8">

                <h3 className="text-2xl font-bold leading-relaxed mt-8 font-serif">Empowering women through knowledge and action.</h3>
            ...
            <h2 className="text-3xl font-bold mb-4 font-serif text-center">Vision, Mission & Values (VMV)</h2>
